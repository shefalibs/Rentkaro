					...
					<tr>
						<td align="center" valign="top" bgcolor="white"
							...
							<div style="font-size:20px;">
								<br>Hello <b>${fName} ${lName}</b>, 
								<br> <br>
								Your email has been verified.
								<br> "Please continue using the app"<br>
								<br><p style="font-size=10px">Thank you for choosing us.</p> 
								<br>  <p style="font-size=6px">${location}</p><br>
								<br>
							</div>
						</td>
					</tr>

...
export class ProductcatalogueComponent implements OnInit {
 ...
 username:string;
  ...
  ngOnInit() {
    ...
    let url= "http://b8java03.iiht.tech:3000/showproduct?category="+this.category+"&city="+this.city;
    fetch(url,{
      method:"GET",
      headers:{
    ...
    let url3="http://b8java03.iiht.tech:3000/viewcart/"+this.cid;
  fetch(url3,{
    method:"GET",
    headers:{
      "content-type":"application/json"
  ...
  .then(data=>{
    ...
    handleClick(city:any){
      ...
      let url= "http://b8java03.iiht.tech:3000/showproduct?category="+this.category+"&city="+city;
      fetch(url,{
        method:"GET",
        headers:{
          "content-type":"application/json"
    ...
    handleClick2(category:any){
      ...
      let url= "http://b8java03.iiht.tech:3000/showproduct?category="+category+"&city="+this.city;
      fetch(url,{
        method:"GET",
        headers:{
          "content-type":"application/json"
    ...
    loggedInUser(){
      ...
      this._url = 'http://b8java03.iiht.tech:3000/findcustomerid/'+this.userid;
      fetch(this._url)
      .then(res=>res.json())
      .then(data=>{
  ...
  addtocart(pid:any){
    ...
    let addurl="http://b8java03.iiht.tech:3000/mycart/"+pid+"/"+this.cid;
    fetch(addurl,{
      method:"GET",
      headers:{
        "content-type":"application/json"

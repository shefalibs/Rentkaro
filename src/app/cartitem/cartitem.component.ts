...
export class CartitemComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let url4 = `http://b8java03.iiht.tech:3000/findcustomerid/` + this.cid;
    fetch(url4, {
      method: "GET",
      headers: {
        "content-type": "application/json"
    ...
    for (var i of this.List5) {
      console.log(i);
      let url5 = `http://b8java03.iiht.tech:3000/showproductbyid/` + i
      fetch(url5, {
        method: "GET",
        headers: {
          "content-type": "application/json"
  ...
  deleteitem(pid: String) {
    let url = "http://b8java03.iiht.tech:3000/deleteitem/" + pid + "/" + this.cid;
    fetch(url, {
      method: "DELETE"
    })
    ...
    for (i = 0; i < this.List7.length; i++) {
      ...
      products.push({ 'productId': this.List7[i] });
  ...
  checkout() {
    ...
    for (let i of this.List) {
      ...
      let url = "http://b8java03.iiht.tech:3000/savecart/" + this.cid + "/" + productid + "/" + quantity;
      fetch(url, {
        method: "GET",
        headers: {
          "content-type": "application/json"

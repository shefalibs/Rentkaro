...
export class ViewproductComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.cid != undefined) {
      this.urlnew = 'http://b8java03.iiht.tech:3000/findcustomerid/' + this.cid;
      fetch(this.urlnew)
        .then(res => res.json())
        .then(data => {
    ...
    let url = "http://b8java03.iiht.tech:3000/showproductbyid/" + this.pid;
    fetch(url, {
      method: "GET",
      headers: {
    ...
    let url2 = "http://b8java03.iiht.tech:3000/showallproduct?city=" + this.city;
    fetch(url2, {
      method: "GET",
      headers: {
        "content-type": "application/json"
